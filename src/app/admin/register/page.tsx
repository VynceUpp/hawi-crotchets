    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 p-6">
      <div className="bg-white rounded-3xl shadow-2xl overflow-hidden max-w-md w-full">
        ...
        <div className="bg-gradient-to-r from-[#dcc0b4] to-purple-300 px-8 py-8 text-center">
          ...
          <h1 className="text-3xl font-bold text-black mb-2 logo">Create Account</h1>
          <p className="text-sm text-gray-700 font-light">Administrator Registration</p>
        </div>
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h4 className="text-sm font-semibold text-blue-800">Password Requirements</h4>
                  <p className="text-sm text-blue-700 mt-1">
                    Must be at least 6 characters long and match confirmation
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center pt-4">
              <p className="text-sm text-gray-600">
                ...
                <button
                  ...
                  className="text-center text-purple-600 hover:text-purple-800 font-medium hover:underline transition-colors duration-200 flex items-center justify-center gap-1"
                >
