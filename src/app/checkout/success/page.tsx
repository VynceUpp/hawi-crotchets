...
const CheckoutSuccessPage: React.FC = () => {
  ...
  const [orderDetails] = useState<OrderDetails>({
    orderNumber: searchParams?.get('order') || 'HT-2024-' + Math.random().toString(36).substr(2, 9).toUpperCase(),
    customerName: searchParams?.get('name') || 'Valued Customer',
    email: searchParams?.get('email') || 'customer@example.com',
    items: [
      {
        id: '1',
        name: 'Cozy Baby Blanket - Soft Pink',
        quantity: 1,
        price: 45.00,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f7d6c5] via-[#ffffff] to-[#ffffff] relative overflow-hidden">
      ...
      <div className="absolute top-32 right-20 w-16 h-16 bg-pink-200/30 rounded-full animate-bounce" style={{ animationDelay: '1s' }} />
      <div className="absolute bottom-20 left-32 w-12 h-12 bg-yellow-200/40 rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className={`text-center mb-12 transform transition-all duration-1000 ${
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Thank you, <span className="font-semibold text-[#8B4513]">{orderDetails.customerName}</span>! 
        ...
        {/* Order Details Card */}
        <div className={`bg-white rounded-2xl shadow-xl p-8 mb-8 transform transition-all duration-1000 ${
          isAnimating ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                ...
                <p className="text-gray-600">
                  Confirmation sent to: <span className="font-medium">{orderDetails.email}</span>
                </p>
              </div>
        ...
        <div className={`bg-gradient-to-r from-[#f7d6c5]/10 to-pink-50 rounded-2xl p-8 mb-8 transform transition-all duration-1000 ${
          isAnimating ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        ...
        <div className={`bg-white rounded-2xl shadow-lg p-8 mb-8 transform transition-all duration-1000 ${
          isAnimating ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        ...
        {/* Action Buttons */}
        <div className={`flex flex-col sm:flex-row gap-4 justify-center transform transition-all duration-1000 ${
          isAnimating ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        ...
        <div className={`text-center mt-12 transform transition-all duration-1000 ${
          ...
          <p className="text-[#8B4513] font-semibold mt-2">
            - The Handmade Treasures Team ✨
          </p>
        </div>
      </div>
